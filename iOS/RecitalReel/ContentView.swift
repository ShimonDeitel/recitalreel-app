...
struct ContentView: View {
    ...
    @State private var editingItem: Performance?
...
struct EditItemView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(item == nil ? "Add Performance" : "Edit Performance")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        var new = item ?? Performance(venue: "", note: "")
                        new.venue = field1
                        new.note = field2
                        onSave(new)
                        dismiss()
